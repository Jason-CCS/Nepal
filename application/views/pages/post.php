...
<header class="intro-header" style="background-image: url('/assets/front/img/post-bg.jpg')">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <a href="#">
                    <img class="img-responsive" src="/assets/front/img/post-sample-image.jpg" alt="">
                </a>
