...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/admin">Jason's Admin v1.0</a>
        </div>
        <!-- /.navbar-header -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="bs-glyphicons col-lg-4">
                                ...
                                <span
                                    class="glyphicon glyphicon-exclamation-sign"> glyphicon-exclamation-sign </span><br/>
                                ...
                                <span
                                    class="glyphicon glyphicon-resize-vertical"> glyphicon-resize-vertical </span><br/>
                                ...
                                <span
                                    class="glyphicon glyphicon-circle-arrow-up"> glyphicon-circle-arrow-up </span><br/>
                                ...
                                <span
                                    class="glyphicon glyphicon-sort-by-alphabet"> glyphicon-sort-by-alphabet </span><br/>
                                <span
                            ...
                            <div class="bs-glyphicons col-lg-4">
                                ...
                                <span
                                    class="glyphicon glyphicon-ice-lolly-tasted"> glyphicon-ice-lolly-tasted </span><br/>
                                ...
                                <span
                                    class="glyphicon glyphicon-option-vertical"> glyphicon-option-vertical </span><br/>
                                ...
                                <span
                                    class="glyphicon glyphicon-text-background"> glyphicon-text-background </span><br/>
                                <span
                                    class="glyphicon glyphicon-object-align-top"> glyphicon-object-align-top </span><br/>
                                <span
                                    class="glyphicon glyphicon-object-align-bottom"> glyphicon-object-align-bottom </span><br/>
                                ...
                                <span
                                    class="glyphicon glyphicon-triangle-bottom"> glyphicon-triangle-bottom </span><br/>
