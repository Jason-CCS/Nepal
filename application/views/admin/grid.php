                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p>Grid classes apply to devices with screen widths greater than or equal to the breakpoint
                            ...
                            <code>.col-md-</code> class to an element will not only affect its styling on medium devices
                            but also on large devices if a
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p>Using a single set of
                            ...
                            stacked on mobile devices and tablet devices (the extra small to small range) before
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p>Don't want your columns to simply stack in smaller devices? Use the extra small and medium
                            device grid classes by adding
                            <code>.col-xs-*</code>
                            <code>.col-md-*</code> to your columns. See the example below for a better idea of how it
                            all works.</p>
                        <div class="row show-grid">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p>With the four tiers of grids available you're bound to run into issues where, at certain
                            breakpoints, your columns don't clear quite right as one is taller than the other. To fix
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p>To nest your content with the default grid, add a new
                            ...
                            <code>.col-md-*</code> column. Nested rows should include a set of columns that add up to
                            12.</p>
                        <div class="row show-grid">
                            <div class="col-md-9">
                                Level 1: .col-md-9
