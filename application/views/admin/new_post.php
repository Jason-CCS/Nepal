                        ...
                        <div class="panel-body">
                            <form role="form">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input id="tags" class="form-control" placeholder="Please type tags here or leave it blank." style="margin-bottom: 10px">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1"
                                               value="deactivate" checked="">Activate Comment
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline2"
                                               value="deactivate">Deactivate Comment
                                    </label>
                                </div>
