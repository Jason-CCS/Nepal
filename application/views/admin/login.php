...
<body>
                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                ...
                                <a href="/assets/admin/pages/index.html" class="btn btn-lg btn-success btn-block">Login</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <script src="/assets/admin/bower_components/bootstrap/diotstrap.min.js"></script>
